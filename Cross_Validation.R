...
# Cross_Validation('./datasets/CellBench/10x_5cl/Labels.csv', 1, './datasets/CellBench/10x_5cl/')
Cross_Validation('./datasets/CellBench/CelSeq2_5cl/Labels.csv', 1, './datasets/CellBench/CelSeq2_5cl/')